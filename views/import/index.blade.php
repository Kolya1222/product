                ...
                <tbody>
                    @forelse($configs as $c)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('presets.module.import.config.edit', $c->id) }}" class="btn btn-xs btn-info">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted">Профилей пока нет. Нажмите "Создать профиль".</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="config_id" class="form-control" required>
                ...
                <div class="col-md-2">
                    <div class="form-check" style="margin-top: 30px;">
                        ...
                        <label for="test_mode" class="form-check-label">Тестовый режим (Dry Run)</label>
                    </div>
                </div>
                <div class="col-md-2">
                    <button id="startImportBtn" class="btn btn-primary btn-block" style="margin-top: 25px;">
        ...
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-md-8">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body" id="errorLog" style="max-height: 300px; overflow-y: auto; font-size: 12px; font-family: monospace; background: #fff5f5;">
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('#startImportBtn').on('click', function() {
            ...
            if (!configId || !fileInput.files.length) {
                alert('Выберите профиль и файл!');
                return;
            }
        ...
        function readChunk(filePath, startRow, configId, isTest) {
            $.ajax({
                ...
                method: 'POST',
                data: { _token: '{{ csrf_token() }}', file_path: filePath, start_row: startRow, config_id: configId },
        ...
        function processChunk(rows, configId, isTest, callback) {
            $.ajax({
                ...
                method: 'POST',
                data: { _token: '{{ csrf_token() }}', rows: rows, config_id: configId, test: isTest },
                success: function(response) {
                    if (response.success) {
        ...
        function finishImport(hasError) {
            isRunning = false;
            $('#startImportBtn').prop('disabled', false).html('<i class="fa fa-play"></i> Запустить');
