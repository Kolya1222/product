...
Route::prefix('catalog')->group( function () {
    Route::get('/{catalogId}/filter',       [CatalogFilterController::class, 'filter'])->name('catalog.filter');
    Route::get('/{catalogId}/filter-state', [CatalogFilterController::class, 'filterState']);
});
